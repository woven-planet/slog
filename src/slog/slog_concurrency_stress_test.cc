...
/*
  $> ./avctl build src/slog:slog_concurrency_stress_test && \
     ./bazel-bin/src/slog/slog_concurrency_stress_test
*/
// 2020-11-11
//
...
#include "src/common/util/init.h"
...
int main(int argc, char** argv) {
  avsoftware::init(&argc, &argv);
  avsoftware::test_slog();
}
