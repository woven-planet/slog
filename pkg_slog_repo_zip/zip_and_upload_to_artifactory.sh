...
echo "https://artifactory.pdx.l5.woven-planet.tech/repository/mothership/${PACKAGE_PATH}/slog-v$1.zip"
...
curl -u "${BUILDKITE_VAULTBUILDKITEPLUGIN_INFRA_NEXUS_BUILDKITE_USERNAME}:${BUILDKITE_VAULTBUILDKITEPLUGIN_INFRA_NEXUS_BUILDKITE_PASSWORD}" \
  ...
  "https://artifactory.pdx.l5.woven-planet.tech/repository/mothership/${PACKAGE_PATH}/slog-v$1.zip"
